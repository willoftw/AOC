...
namespace AOC1.Tests
{
    public class UnitTest1
    {

        List<int> testset1 = new List<int> { 1721,
                                            979,
                                            366,
                                            299,
                                            675,
